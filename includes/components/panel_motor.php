           ...
           <div class="col-12 mt-1 pt-2 pb-1 d-flex justify-content-between align-items-center border-top border-info" style="border-color: rgba(13, 202, 240, 0.2) !important;">
               <div class="d-flex gap-4">
                   <div class="form-check form-switch m-0 d-flex align-items-center">
                       ...
                       <label class="form-check-label text-secondary small" style="margin-top: 1px;" for="toggleSamplers"><?= __('lbl_show_all') ?? 'Mostrar todos' ?> (Sampler)</label>
                   </div>
                   <div class="form-check form-switch m-0 d-flex align-items-center">
                       <input class="form-check-input mt-0 me-2 border-secondary" style="cursor: pointer;" type="checkbox" id="toggleSchedulers" onchange="document.querySelectorAll('.adv-scheduler').forEach(el => this.checked ? el.classList.remove('d-none') : el.classList.add('d-none'))">
               ...
               <div class="form-check form-switch m-0 d-flex align-items-center">
                   ...
                   <label class="form-check-label small text-info fw-bold" style="margin-top: 1px;" for="dynThreshToggle">
                       <i class="bi bi-speedometer"></i> <?= __('vid_dyn_thresh') ?? 'Dyn. Thresholding' ?>
                   </label>
               </div>
           </div>
...
<!-- ======================================================= -->
<!-- PANEL LATERAL: MONITOR DE SISTEMA EN TIEMPO REAL -->
<!-- ======================================================= -->
<div class="offcanvas offcanvas-end bg-dark text-light border-start border-secondary" tabindex="-1" id="monitorSistemaOffcanvas" data-bs-scroll="true" data-bs-backdrop="false" style="width: 380px; box-shadow: -5px 0 25px rgba(0,0,0,0.8);">
